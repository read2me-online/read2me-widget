...
var Read2MePlayerBuilder = function () {
    ...
    _createClass(Read2MePlayerBuilder, null, [{
        ...
        value: function _replaceBlueprintWithPlayer(elem) {
            ...
            if (ignoreContentChange === 'true') ignoreContentChange = true;else if (ignoreContentChange === 'false') ignoreContentChange = false;else throw 'Unsupported value for ignoreContentChange (can be "true" or "false")';
