...
var SVGInline = (function(_Component) {
  ...
  function SVGInline() {
    ...
    return _possibleConstructorReturn(
      this,
      (SVGInline.__proto__ || Object.getPrototypeOf(SVGInline)).apply(
        this,
        arguments
      )
    );
  ...
  _createClass(SVGInline, [
    {
      ...
      value: function render() {
        var _props = this.props,
          ...
          componentProps = _objectWithoutProperties(_props, [
            'className',
            'component',
            'svg',
            'fill',
        ...
        var svgClasses =
          classes.split(' ').join(classSuffix + ' ') + classSuffix;
        var svgStr = SVGInline.cleanupSvg(svg, cleanup).replace(
          /<svg/,
          '<svg class="' +
            svgClasses +
            '"' +
        ...
        if (accessibilityLabel) {
          ...
          svgStr =
            svgStr.substr(0, _pos) +
            (' role="img" aria-labelledby="' + id + '"') +
            svgStr.substr(_pos, 1) +
...
SVGInline.propTypes = {
  ...
  cleanup: _propTypes2.default.oneOfType([
